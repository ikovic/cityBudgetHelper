      ...
      <div id="loginWrapper">
        <Card shadow={0} style={{width: '320px', height: '300px', margin: 'auto'}}>
          <CardTitle
            ...
            {i18n.getTranslation(keys.LOGIN.TITLE)}
          </CardTitle>
          <CardText>
            <Textfield onChange={(e) => {
              this._handleChange('email', e)
            }}
                       label={i18n.getTranslation(keys.LOGIN.USERNAME)}
                       floatingLabel
                       style={{width: '100%'}}/>
            <Textfield onChange={(e) => {
              this._handleChange('password', e)
            }}
                       label={i18n.getTranslation(keys.LOGIN.PASSWORD)}
                       floatingLabel
                       type="password"
                       style={{width: '100%'}}/>
          </CardText>
          <CardActions border>
            <Button colored
              ...
              {i18n.getTranslation(keys.LOGIN.CONFIRM)}
            </Button>
          </CardActions>
        </Card>
      </div>
